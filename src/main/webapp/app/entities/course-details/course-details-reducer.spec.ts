...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEDETAILS actions', async () => {
      const expectedActions = [
        {
