...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERDETAILS actions', async () => {
      const expectedActions = [
        {
