...
export const EnrollmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="courseManagementApp.enrollment.delete.question">Are you sure you want to delete this Enrollment?</ModalBody>
      <ModalFooter>
        <Button color="secondary" onClick={handleClose}>
          <FontAwesomeIcon icon="ban" />
          &nbsp; Cancel
        </Button>
        <Button id="cm-confirm-delete-enrollment" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
