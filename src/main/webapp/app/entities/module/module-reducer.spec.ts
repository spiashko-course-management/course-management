...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './module.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MODULE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MODULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MODULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MODULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MODULE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MODULE actions', async () => {
      const expectedActions = [
        {
