...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USEREXTRAINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_USEREXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USEREXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USEREXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USEREXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USEREXTRAINFO actions', async () => {
      const expectedActions = [
        {
