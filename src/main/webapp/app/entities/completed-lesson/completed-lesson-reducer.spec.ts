...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPLETEDLESSON_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPLETEDLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPLETEDLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPLETEDLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPLETEDLESSON actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPLETEDLESSON actions', async () => {
      const expectedActions = [
        {
