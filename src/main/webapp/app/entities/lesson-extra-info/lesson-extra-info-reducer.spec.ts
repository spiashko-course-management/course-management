...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './lesson-extra-info.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LESSONEXTRAINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_LESSONEXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LESSONEXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LESSONEXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LESSONEXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LESSONEXTRAINFO actions', async () => {
      const expectedActions = [
        {
