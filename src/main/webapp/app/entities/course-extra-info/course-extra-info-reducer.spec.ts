...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURSEEXTRAINFO_LIST actions', async () => {
    ...
    it('dispatches FETCH_COURSEEXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURSEEXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURSEEXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURSEEXTRAINFO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURSEEXTRAINFO actions', async () => {
      const expectedActions = [
        {
