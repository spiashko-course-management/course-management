...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LESSONDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_LESSONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LESSONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LESSONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LESSONDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LESSONDETAILS actions', async () => {
      const expectedActions = [
        {
