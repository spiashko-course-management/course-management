 ...
 */
export type IGetListQueryParams = { include?: string; filter?: string; page?: number; size?: number; sort?: string };
export type IGetSingleQueryParams = { id?: number | string; include?: string; filter?: string };
/**
