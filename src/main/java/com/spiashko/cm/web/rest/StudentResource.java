...
/**
 * REST controller for managing {@link com.spiashko.cm.domain.Student}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class StudentResource {
    ...
    public StudentResource(StudentRepository studentRepository, ExtendedUserRepository extendedUserRepository) {
