...
import com.spiashko.cm.domain.Payment;
import com.spiashko.cm.repository.StudentRepository;
...
public class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        ...
        student.setExtendedUser(extendedUser);
        // Add required entity
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getId()).isEqualTo(testStudent.getExtendedUser().getId());
    }
    ...
    public void updateStudentMapsIdAssociationWithNewId() throws Exception {
        ...
        updatedStudent.setExtendedUser(extendedUser);
