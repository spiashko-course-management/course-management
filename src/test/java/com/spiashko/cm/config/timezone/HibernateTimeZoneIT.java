package com.spiashko.cm.config.timezone;

import com.spiashko.cm.CourseManagementApp;
import com.spiashko.cm.config.TestSecurityConfiguration;
import com.spiashko.cm.repository.timezone.DateTimeWrapper;
import com.spiashko.cm.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM cm_date_time_wrapper where id=%d", fieldName, id);
    }
